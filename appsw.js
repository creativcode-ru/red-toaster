...
self.addEventListener("activate", event => {
    ...
    /* Cервис-воркер начинает обслуживать контент, как только он будет активирован, а не со следующей загрузки страницы.
     * Это нужно, чтобы ранее кешированную страницу воркер брал из кеша а не из сети.
     * 
